 ...
 * @since 0.0.0
 */
function _manually_load_wp_adserve_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wp-adserve.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wp_adserve_plugin' );
